...
In the prior step, you've set up an Azure AD tenant to fullfil your [cluster's control plane (Cluster API) authorization](./03-aad.md) needs for this reference implementation deployment; now we'll prepare the the subscription in which will be hosting this workload.
...
1. Login into the Azure subscription that you'll be deploying into.
   ...
   ```bash
   az login --tenant $TENANTID_AZURERBAC
   ```
